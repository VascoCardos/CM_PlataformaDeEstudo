...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerViews() {
        ...
        popularAdapter = PopularSubjectsAdapter(
            ...
            onViewStudiesClick = { subject -> navigateToStudies(subject) },
            onViewSessionsClick = { subject -> navigateToSessions(subject) }
        )
    ...
    private fun navigateToStudies(subject: Subject) {
    ...
    private fun navigateToSessions(subject: Subject) {
        showToast("Sessions for ${subject.name} - Coming soon!")
        // TODO: Navigate to sessions activity
    }
}
